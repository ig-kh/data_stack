...
4. В приложении применены три оптимизаци - персист, репартицирование и вызов skala-udf (исходные коды и результаты сборки sbt в src/skala/iirf/*) вместо python-udf.
